          ...
          >
            {oauthLoading ? (
              ...
              <svg className="w-5 h-5" viewBox="0 0 48 48" aria-hidden="true">
                <g>
                  <path fill="#4285F4" d="M24 9.5c3.54 0 6.55 1.22 8.71 3.25l6.46-6.45C34.37 2.53 29.7 0 24 0 14.82 0 6.81 5.91 2.99 14.44l7.52 5.84C12.5 14.08 17.78 9.5 24 9.5z"/>
                  ...
                  <path fill="#EA4335" d="M24 48c6.48 0 11.93-2.15 15.91-5.86l-7.34-5.7c-2.1 1.43-4.8 2.26-8.57 2.26-6.17 0-11.39-4.13-13.28-9.67l-8.52 6.06C6.8 42.06 14.68 48 24 48z"/>
