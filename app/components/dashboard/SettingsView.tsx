      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-neutral-800 text-gray-900 dark:text-neutral-100"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              disabled
              className="w-full px-4 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg bg-gray-50 dark:bg-neutral-800 dark:text-neutral-400 text-gray-500 cursor-not-allowed"
            />
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`p-4 rounded-lg border-2 transition-all ${
                formData.faith === "hinduism"
                  ? "border-amber-600 bg-amber-50 dark:border-yellow-600 dark:bg-neutral-800"
                  : "border-gray-200 hover:border-gray-300 dark:border-neutral-700 dark:hover:border-yellow-700"
              }`}
            >
              <div className="font-medium text-gray-900 dark:text-yellow-100">Hinduism</div>
            ...
            >
              <div className="font-medium text-gray-900 dark:text-yellow-100">Sikhism</div>
              <div className="text-sm text-gray-600 dark:text-neutral-300">Gurbani & Seva</div>
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="font-medium text-gray-900 dark:text-yellow-100">INR (₹)</div>
            </button>
            <button
              type="button"
              onClick={() =>
            ...
            >
              <div className="font-medium text-gray-900 dark:text-yellow-100">USD ($)</div>
            </button>
          </div>
        </div>

        {success && (
          <div className="bg-green-50 dark:bg-green-900 text-green-600 dark:text-green-200 px-4 py-3 rounded-lg text-sm">
            {success}
          </div>
        )}
